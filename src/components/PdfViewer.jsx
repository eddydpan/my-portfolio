...
export default function PdfViewer({ src, initialPage = 1 }) {
  ...
  return (
    <div className="pdf-viewer my-6 flex justify-center">
      <div className="bg-white rounded shadow p-4" style={{ maxWidth: '600px', width: '100%', maxHeight: '500px', overflowY: 'auto' }}>
        {error ? (
          ...
          <>
            <Document file={src} onLoadSuccess={onDocumentLoadSuccess} onError={onDocumentLoadError}>
              <Page pageNumber={pageNumber} width={560} renderTextLayer={false} />
            </Document>
